...
partial class JumpTable
{
    ...
    public virtual void NewBuffer(ExecutionEngine engine, Instruction instruction, out RunStats? runStats)
    {
        int length = (int)engine.Pop().GetInteger();
        engine.Limits.AssertMaxItemSize(length);
        engine.Push(new Buffer(length));
        runStats = new RunStats { Length = length };
    }
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public virtual void Memcpy(ExecutionEngine engine, Instruction instruction, out RunStats? runStats)
    {
        ...
        runStats = new RunStats { Length = count };
    }
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public virtual void Cat(ExecutionEngine engine, Instruction instruction, out RunStats? runStats)
    {
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public virtual void SubStr(ExecutionEngine engine, Instruction instruction, out RunStats? runStats)
    {
        int count = (int)engine.Pop().GetInteger();
        if (count < 0)
    ...
    /// <remarks>Pop 2, Push 1</remarks>
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public virtual void Left(ExecutionEngine engine, Instruction instruction, out RunStats? runStats)
    {
        int count = (int)engine.Pop().GetInteger();
        if (count < 0)
    ...
    /// <remarks>Pop 2, Push 1</remarks>
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public virtual void Right(ExecutionEngine engine, Instruction instruction, out RunStats? runStats)
    {
        int count = (int)engine.Pop().GetInteger();
        if (count < 0)
