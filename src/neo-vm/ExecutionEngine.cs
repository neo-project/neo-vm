...
namespace Neo.VM
{
    public class ExecutionEngine : IDisposable
    {
        ...
        private InstructionSet.delOnInstruction[] _jumpTable;
        ...
        /// <returns></returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        internal bool CheckStackSize(bool strict, int count = 1)
        {
        ...
        public ExecutionEngine(InstructionSet set = null)
        {
            _jumpTable = set == null ? InstructionSet.Default.GetJumpTable() : set.GetJumpTable();
        }
        ...
        private bool ExecuteInstruction()
        {
            ...
            var code = _jumpTable[(byte)instruction.OpCode];

            if (code != null)
            {
                return code(this, context, instruction);
            }
        ...
        internal void RaiseContextUnloaded(ExecutionContext e) => ContextUnloaded?.Invoke(this, e);
        internal void RaiseContextLoaded(ExecutionContext e) => ContextLoaded?.Invoke(this, e);

        internal void LoadContext(ExecutionContext context)
        {
        ...
        internal virtual bool OnSysCall(uint method) => false;
